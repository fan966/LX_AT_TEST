...
@ddt
class Api_Finance_CheckAmount(unittest.TestCase):
    ...
    def test_Finance_CheckAmount(self,datas):
        ...
        logging.info('=======================调用【检测充值金额】接口====================================')
        self.actual_result = http_api_requests('充值提现.检测充值金额', Headers={"LoginSessionID": self.LoginSessionID},
